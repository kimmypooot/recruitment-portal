<template>
  ...
  <Transition
    ...
    <div v-if="modelValue"
      ...
      <!-- Header -->
      <div class="flex items-center justify-between px-5 py-4 border-b border-gray-200 bg-primary text-white flex-shrink-0">
        <div>
      ...
      <div v-else-if="error" class="flex-1 flex items-center justify-center p-8 text-center">
        <div>
          ...
          <button @click="load" class="mt-3 text-xs text-primary hover:underline">Retry</button>
        </div>
      </div>
