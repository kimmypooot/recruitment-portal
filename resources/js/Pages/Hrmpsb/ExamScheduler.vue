<template>
  <HrmpsbLayout title="Exam Scheduler" :vacancyId="props.vacancyId">
      ...
      >
        <div class="mt-4 flex items-center gap-1">
          <a :href="`/hrmpsb/exam-schedule/${props.vacancyId}?exam_type=TWE`"
            ...
            :class="examType === 'TWE' ? 'bg-primary text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'">
          ...
          <table class="min-w-full">
            ...
            <tbody class="divide-y divide-gray-50">
              <tr
                ...
                :class="isSelected(app.id) ? 'bg-primary/5' : ''"
