  ...
  <div class="min-h-screen flex flex-col bg-gray-50">
    ...
    <header class="bg-white border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/register" class="text-sm text-blue-700 font-medium hover:underline">
          Create account
        </Link>
      </div>
    </header>
    ...
    <main class="flex-1 flex items-center justify-center px-4 py-12">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-sm text-gray-500 mt-1">Sign in to track your application</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-8">
          ...
          <p class="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/register" class="text-blue-700 font-medium hover:underline">Create one</Link>
          </p>
